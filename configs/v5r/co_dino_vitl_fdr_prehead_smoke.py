"""Two-segment engineering smoke for the clean V5R lineage."""

_base_ = ["./co_dino_vitl_fdr_prehead_fold0.py"]

model = dict(
    transition_updates=2,
    neck=dict(transition_updates=2),
    query_head=dict(transition_updates=2),
)
data = dict(
    train=dict(
        max_images=4,
...
log_level = "WARNING"
work_dir = "storage/v5r/smoke/co_dino_vitl_fdr_prehead"
